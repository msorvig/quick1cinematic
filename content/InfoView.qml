    ...
    Item {
        ...
        Flickable {
            ...
            Column {
                ...
                InfoViewItem {
                    text: "Welcome to <i>'Cinematic Experience'</i> demo. This demo is a limited version of the application that demoes features in Qt 5, ported to QtQuick 1.1 and the Qt.labs.shaders plugin. Particle, PathAnimation and Sprite effects have been removed because they are QtQuick 2.0 specific features."
