...
Item {
    ...
    ShaderEffect {
        ...
        property variant srcNmap1: coverNmapSource
        ...
        fragmentShader: "
            ...
            void main() {
                ...
                highp vec4 pix2 = texture2D(srcNmap1, qt_TexCoord0.st);
                ...
                gl_FragColor = vec4(color, 1.0) * pix.a * qt_Opacity;
            }
        "
    }
}
